...
class SslCommerzPaymentController extends Controller
{
    ...
    public function success(Request $request)
    {
        ...
        if ($order_details->order_status == 'Pending') {
            ...
            return back()->with('msg','Transaction is Invalid.');
        }
    ...
    public function fail(Request $request)
    {
        ...
        if ($order_details->order_status == 'Pending') {
            ...
            return back()->with('msg','Transaction is Failed.');
        } else if ($order_details->order_status == 'Processing' || $order_details->order_status == 'Complete') {
            echo "Transaction is already Successful";
            return back('/complete-order')->with('msg','Transaction is already Successful.');
        } else {
    ...
    public function cancel(Request $request)
    {
        ...
        if ($order_details->order_status == 'Pending') {
            ...
            return back()->with('msg','Transaction is Cancel.');
        } else if ($order_details->order_status == 'Processing' || $order_details->order_status == 'Complete') {
            echo "Transaction is already Successful";
            return back('/complete-order')->with('msg','Transaction is already Successful.');
        } else {
    ...
    public function ipn(Request $request)
    {
        ...
        if ($request->input('tran_id')) #Check transation id is posted or not.
        {
            ...
            if ($order_details->order_status == 'Pending') {
                ...
                if ($validation == TRUE) {
                    ...
                    */
                    ...
                    echo "Transaction is successfully Completed";
                    return back('/complete-order')->with('msg','Transaction is successfully Completed.');
                }
            } else if ($order_details->order_status == 'Processing' || $order_details->order_status == 'Complete') {
                ...
                return back('/complete-order')->with('msg','Transaction is already successfully Completed.');
            } else {
                #That means something wrong happened. You can redirect customer to your product page.
            ...
            echo "Invalid Data";
            return back()->with('msg','Invalid Data.');
        }
    }
