...
class Setting extends Model
{
    ...
    public static function newSetting($request){
        ...
        if($request->file('android_app_image')){
            self::$setting->android_app_image = imageUpload($request->file('android_app_image'),'upload/settingImages/');
        }else{
            self::$setting->android_app_image = 'upload/product.png';
        }
        if($request->file('ios_app_image')){
            self::$setting->ios_app_image = imageUpload($request->file('ios_app_image'),'upload/settingImages/');
        }else{
            self::$setting->ios_app_image = 'upload/product.png';
        }
        if($request->file('logo_jpg')){
            self::$setting->logo_jpg = imageUpload($request->file('logo_jpg'),'upload/settingImages/');
        }else{
            self::$setting->logo_jpg = 'upload/product.png';
        }
        if($request->file('logo_png')){
            self::$setting->logo_png = imageUpload($request->file('logo_png'),'upload/settingImages/');
        }else{
            self::$setting->logo_png  = 'upload/product.png';
        }
        if($request->file('payment_method_image')){
            self::$setting->payment_method_image = imageUpload($request->file('payment_method_image'),'upload/settingImages/');
        }else{
            self::$setting->payment_method_image = 'upload/product.png';
        }
        if($request->file('favicon')){
            self::$setting->favicon = imageUpload($request->file('favicon'),'upload/settingImages/');
        }else{
            self::$setting->favicon = 'upload/product.png';
        }
    ...
    public static function updateSetting($request,$setting){
        ...
        if($request->file('android_app_image')){
            $setting->android_app_image = imageUpload($request->file('android_app_image'),'upload/settingImages/');
        }
        if($request->file('ios_app_image')){
            $setting->ios_app_image = imageUpload($request->file('ios_app_image'),'upload/settingImages/');
        }
        if($request->file('logo_jpg')){
            $setting->logo_jpg = imageUpload($request->file('logo_jpg'),'upload/settingImages/');
        }
        if($request->file('logo_png')){
            $setting->logo_png = imageUpload($request->file('logo_png'),'upload/settingImages/');
        }
        if($request->file('payment_method_image')){
            $setting->payment_method_image = imageUpload($request->file('payment_method_image'),'upload/settingImages/');
        }
        if($request->file('favicon')){
            $setting->favicon = imageUpload($request->file('favicon'),'upload/settingImages/');
        }
