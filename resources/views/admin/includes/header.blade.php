                                    ...
                                    <div class="header-dropdown-list cart-menu ps4 overflow-hidden">
                                        <a class="dropdown-item d-flex p-4" href="cart.html">
                                            ...
                                            <div class="wp-60 cart-desc mt-1">
                                                <p class="fs-13 mb-0 lh-1 text-dark fw-500">TrueBasket
                                                    Metal Single Pot</p>
                                        ...
                                        <a class="dropdown-item d-flex p-4" href="cart.html">
                                            ...
                                            <div class="wp-60 cart-desc mt-1">
                                                <p class="fs-13 mb-0 lh-1 text-dark fw-500">Authentic
                                                    chair with Canopy</p>
                                                <p class="fs-12 fw-300 lh-1 mb-0">Status: <span
                                                        class="text-green">In Stock</span></p>
                                        ...
                                        <a class="dropdown-item d-flex p-4" href="cart.html">
                                            ...
                                            <div class="wp-60 cart-desc mt-1">
                                                <p class="fs-13 mb-0 lh-1 text-dark fw-500">Casual
                                                    Sneakers Canvas</p>
                                                <p class="fs-12 fw-300 lh-1 mb-0">Status: <span
                                                        class="text-green">In Stock</span></p>
                                                <span class="fs-12 fw-300 lh-1 mb-0">Quantity: 03</span>
                                        ...
                                        <a class="dropdown-item d-flex p-4" href="cart.html">
                                            ...
                                            <div class="wp-60 cart-desc mt-1">
                                                <p class="fs-13 mb-0 lh-1 text-dark fw-500">Branded
                                                    Head Phones</p>
                                                <p class="fs-12 fw-300 lh-1 mb-0">Status: <span
                                        ...
                                        <a class="dropdown-item d-flex p-4" href="cart.html">
                                            ...
                                            <div class="wp-60 cart-desc mt-1">
                                                <p class="fs-13 mb-0 lh-1 text-dark fw-500">camera
                                                    lens (16mm f/1.4)</p>
                                                <p class="fs-12 fw-300 lh-1 mb-0">Status: <span
                                                        class="text-green">In Stock</span></p>
