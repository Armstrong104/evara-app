            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Size Module</span><i class="angle fa fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Product Offer Module</span><i
                            class="angle fa fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">UI Elements</a></li>
                        <li><a href="{{route('product_offer.create')}}" class="slide-item">Add Product Offer</a></li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Feature Module</span><i
                            class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Charts</a></li>
                        <li><a href="{{route('feature.create')}}" class="slide-item"> Add Feature</a></li>
                        <li><a href="{{route('feature.index')}}" class="slide-item"> Manage Feature</a></li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">User Module</span><i
                            class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        ...
                        <li><a href="border.html" class="slide-item">Manage User</a></li>
                    </ul>
                </li>
            </ul>
