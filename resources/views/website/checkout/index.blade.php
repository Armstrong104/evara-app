...
@section('title', 'Checkout Section')
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            @if (isset($customer->email))
                                <input type="email" name="email" required="" readonly value="{{ $customer->email }}"
                        ...
                        <div class="form-group">
                            <textarea required="" name="delivery_address" rows="3" placeholder="Delivery Address"></textarea>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach (Cart::content() as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <h5><a href="shop-product-full.html">{{ $item->name }}</a></h5>
                                        ...
                                        <tr>
                                            <th>Tax Amount (15%)</th>
                                            <td class="product-subtotal" colspan="2">{{ $tax = round($sum * 0.15) }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Shipping</th>
                                            <td colspan="2"><em>{{ $shippingCost = 100 }}</em></td>
                                        </tr>
                                        <tr>
                                            <th>Total</th>
                                            <td colspan="2" class="product-subtotal"><span
                                                    class="font-xl text-brand fw-900">{{ $orderTotal = $sum + $tax + $shippingCost }}</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
