            ...
            <div class="carausel-6-columns text-center" id="carausel-6-columns-3">
                <div class="brand-logo">
                    <img class="img-grey-hover"
                        src="{{ asset('/') }}website/assets/imgs/banner/brand-1.png" alt="">
                </div>
                <div class="brand-logo">
                    <img class="img-grey-hover"
                        src="{{ asset('/') }}website/assets/imgs/banner/brand-2.png" alt="">
                </div>
                <div class="brand-logo">
                    <img class="img-grey-hover"
                        src="{{ asset('/') }}website/assets/imgs/banner/brand-3.png" alt="">
                </div>
                <div class="brand-logo">
                    <img class="img-grey-hover"
                        src="{{ asset('/') }}website/assets/imgs/banner/brand-4.png" alt="">
                </div>
                <div class="brand-logo">
                    <img class="img-grey-hover"
                        src="{{ asset('/') }}website/assets/imgs/banner/brand-5.png" alt="">
                </div>
                <div class="brand-logo">
                    <img class="img-grey-hover"
                        src="{{ asset('/') }}website/assets/imgs/banner/brand-6.png" alt="">
                </div>
                <div class="brand-logo">
                    <img class="img-grey-hover"
                        src="{{ asset('/') }}website/assets/imgs/banner/brand-3.png" alt="">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="banner-img banner-1 wow fadeIn animated">
                            <img src="{{ asset('/') }}website/assets/imgs/banner/banner-5.jpg"
                                alt="">
                            <div class="banner-text">
                    ...
                    <div class="col-md-6">
                        <div class="banner-img mb-15 wow fadeIn animated">
                            <img src="{{ asset('/') }}website/assets/imgs/banner/banner-6.jpg"
                                alt="">
                            <div class="banner-text">
                                <span>Big Offer</span>
                        ...
                        <div class="banner-img banner-2 wow fadeIn animated">
                            <img src="{{ asset('/') }}website/assets/imgs/banner/banner-7.jpg"
                                alt="">
                            <div class="banner-text">
                                <span>Smart Offer</span>
