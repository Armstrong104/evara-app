                        ...
                        <div class="row mb-50">
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-gallery">
                                    ...
                                    <div class="product-image-slider">
                                        @foreach ($product->productImages as $productImage)
                                            <figure class="border-radius-10">
                                                <img style="height: 500px; width:100%;" src="{{ asset($productImage->image) }}" alt="product image">
                                            </figure>
                                        @endforeach
                                    ...
                                    <!-- THUMBNAILS -->
                                    <div class="slider-nav-thumbnails ps-15 pe-15">
                                        @foreach ($product->productImages as $productImage)
                                            <figure class="border-radius-10">
                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="attr-detail attr-color mb-15">
                                            ...
                                            <div class="mt-3">
                                                @foreach ($product->colors as $key => $color)
                                                    <label><input type="radio" name="color" {{ $key == 0 ? 'checked' : '' }} style="width: 20px; height:20px;" value="{{ $color->color->name }}"/> {{ $color->color->name }} </label>
                                                @endforeach
                                            </div>
                                        </div>
                                        <div class="attr-detail attr-size">
                                            ...
                                            <div class="mt-3">
                                                @foreach ($product->sizes as $key1 => $size)
                                                    <label ><input type="radio" name="size" {{ $key1 == 0 ? 'checked' : '' }} style="width: 20px; height:20px;" value="{{ $size->size->code }}"/> {{ $size->size->code }} </label>
                                                @endforeach
                                            </div>
                                        </div>
                                        ...
                                        <div class="detail-extralink">
                                            ...
                                            <div class="product-extra-link2">
                                                ...
                                                <a aria-label="Add To Wishlist" class="action-btn hover-up"
                                                    href="{{ route('wishlist.add',$product->id) }}"><i class="fi-rs-heart"></i></a>
                                        ...
                                        <ul class="product-meta font-xs color-grey mt-50">
                                            ...
                                            <li>Availability:<span
                                                    class="in-stock text-success ml-5">{{ $product->stock_amount }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </form>
                                            ...
                                            <div class="product-cart-wrap small hover-up">
                                                ...
                                                <div class="product-content-wrap">
                                                    ...
                                                    <div class="product-price">
                                                        ...
                                                        <span class="old-price">Tk.
                                                            {{ $category_product->regular_price }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
