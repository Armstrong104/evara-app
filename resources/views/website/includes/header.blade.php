                        ...
                        <div class="header-info">
                            <ul>
                                <li><i class="fi-rs-smartphone"></i> <a
                                        href="#">{{ $setting->contact_phone }}</a></li>
                                ...
                                @if (Session::get('customer_id'))
                                    <li>
                                        <a class="language-dropdown-active" href="#"> <i
                                                class="fi-rs-world"></i>
                                            {{ Session::get('customer_name') }} <i
                                                class="fi-rs-angle-small-down"></i></a>
                                        <ul class="language-dropdown">
                                            <li><a href="{{ route('customer.dashboard') }}"><i
                                                        class="fi-rs-home"></i>Dashboard</a></li>
                                            <li><a href="{{ route('customer-logout') }}"><i
                                                        class="fi-rs-lock"></i>Logout</a></li>
                                        </ul>
                                    </li>
                                @else
                                    <li><i class="fi-rs-user"></i><a href="{{ route('login-register') }}">Login /
                                            SignUp</a></li>
                                @endif
                            </ul>
                        </div>
                                            ...
                                            @foreach (Cart::content() as $cartItem)
                                                <li>
                                                    ...
                                                    <div class="shopping-cart-delete">
                                                        <a href="{{ route('cart.delete', ['rowId' => $cartItem->rowId]) }}"
                ...
                <div class="header-wrap header-space-between position-relative">
                    <div class="logo logo-width-1 d-block d-lg-none">
                        <a href="{{ route('home') }}"><img
                                src="{{ asset('/') }}website/assets/imgs/theme/logo.svg" alt="logo"></a>
                    </div>
                                                                    ...
                                                                    <ul>
                                                                        @foreach ($category->subCategory as $subCategory)
                                                                            <li><a class="dropdown-item nav-link nav_item"
                                                                                    href="{{ route('product-sub-category', ['id' => $subCategory->id]) }}">{{ $subCategory->name }}</a>
                                                                            </li>
                                                                        @endforeach
        ...
        <div class="mobile-header-wrapper-inner">
            <div class="mobile-header-top">
                <div class="mobile-header-logo">
                    <a href="{{ route('home') }}"><img src="{{ asset($setting->logo_png) }}"
                            alt="logo"></a>
                </div>
                ...
                <div class="mobile-menu-wrap mobile-header-border">
                    ...
                    <nav>
                        <ul class="mobile-menu">
                            ...
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a
                                    href="{{ route('purchase-guide') }}">Purchase Guide</a>
                            </li>
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a
                                    href="{{ route('shipping-policy') }}">Shipping Policy</a>
                            </li>
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a
                                    href="{{ route('return-policy') }}">Return Policy</a>
                            </li>
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a
                                    href="{{ route('terms-condition') }}">Terms & Condition</a>
                            </li>
                        </ul>
                    </nav>
                    <!-- mobile menu end -->
