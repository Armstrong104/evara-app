                ...
                <div class="col-lg-9">
                    <div class="single-page pr-30 mb-lg-0 mb-sm-5">
                        ...
                        <figure class="single-thumbnail">
                            <img src="{{asset('/')}}website/assets/imgs/blog/blog-10.jpg" alt="">
                        </figure>
                        ...
                        <div class="sidebar-widget widget_alitheme_lastpost mb-20">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                    <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                        <a href="blog-post-fullwidth.html">
                                            <img src="{{asset('/')}}website/assets/imgs/blog/blog-3.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-content media-body">
                                ...
                                <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                    <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                        <a href="blog-post-fullwidth.html">
                                            <img src="{{asset('/')}}website/assets/imgs/blog/blog-4.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-content media-body">
                                ...
                                <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                    <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                        <a href="blog-post-fullwidth.html">
                                            <img src="{{asset('/')}}website/assets/imgs/blog/blog-5.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-content media-body">
                                ...
                                <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                    <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                        <a href="blog-post-fullwidth.html">
                                            <img src="{{asset('/')}}website/assets/imgs/blog/blog-6.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-content media-body">
