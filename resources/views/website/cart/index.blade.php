                ...
                <div class="col-12">
                    <form action="{{ route('cart.update-product') }}" method="post">
                                    ...
                                    @foreach ($products as $key => $product)
                                        <tr>
                                            <td class="image product-thumbnail"><img
                                                    src="{{ asset($product->options->image) }}" alt="#"></td>
                        ...
                        <div class="cart-action text-end">
                            <button type="submit" class="btn  mr-10 mb-sm-15"><i class="fi-rs-shuffle mr-10"></i>Update
                                Cart</button>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="cart_total_amount">
                                                     ...
                                                     Shipping Cost :Tk {{ $shippingCost = 100 }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="cart_total_label">Total</td>
                                                <td class="cart_total_amount"><strong><span
                                                            class="font-xl fw-900 text-brand">Tk. {{ $orderTotal =  $sum + $tax + $shippingCost }}</span></strong></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
